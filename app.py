...
def predict():
    if request.method == "POST":
        ...
        if 'mintemp' not in request.form or not request.form['mintemp']:
            return render_template("error.html", message="Minimum temperature is required.")
        ...
        try:
            ...
            return render_template("error.html", message="Invalid input value: " + str(e))
